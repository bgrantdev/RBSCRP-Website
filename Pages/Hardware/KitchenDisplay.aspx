<%@ Page Title="" Language="C#" MasterPageFile="~/RBSCRP.Master" AutoEventWireup="true" CodeBehind="KitchenDisplay.aspx.cs" Inherits="RBSCRP_Wwebsite.Pages.Hardware.KitchenDisplay" %>
    ...
    <div id="hardwareMenuWrapper">
        <div class="hardwareMenu">
            <div class="hardwareTitle">
                ...
                The kitchen displays will be on this page.
            </div>
